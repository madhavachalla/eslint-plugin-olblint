        ...
        return {
            ...
            ObjectExpression: function (node) {
                ...
                node.properties.forEach(property => {
                    let propertyName = propert.key.type === "Identifier" ? property.key.name : property.key.value;
                    if ((isValidWidgetName(propertyName) || properties.indexOf(propertyName)) > -1 && property.value.type === "Literal" && isInvalidLiteralValue(property.value.value)) {
